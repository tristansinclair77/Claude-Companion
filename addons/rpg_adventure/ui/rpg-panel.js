...
`;
  ...
  const LOG_MSG = {
    ...
    player_attack:   (e) => e.hit ? `▶ You strike for ${e.damage} dmg${e.isCrit ? ' [CRIT!]' : ''}` : '▶ Your attack missed!',
    companion_assist:(e) => `▶ [Companion] assists — ${e.damage} dmg!`,
    enemy_attack:    (e) => e.hit ? `▶ ${e.enemyName || 'Enemy'} hits for ${e.damage} dmg${e.isCrit ? ' [CRIT!]' : ''}` : '▶ Enemy missed!',
